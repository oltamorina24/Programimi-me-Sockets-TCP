...
### TCP Server & Client në PHP

##  Përshkrimi i Projektit

Ky projekt implementon një server TCP dhe klientë në gjuhën PHP, të cilët komunikojnë në një rrjet real. Serveri menaxhon lidhjet e shumë klientëve, përpunon kërkesat e tyre dhe ruan mesazhet për monitorim. Gjithashtu, serveri përfshin një HTTP server të thjeshtë për monitorimin e statistikave në kohë reale.
...
Serveri HTTP punon paralelisht në portin 9090.

Endpoint: GET /stats

Kthen: numrin e klientëve aktivë, IP adresat, numrin e mesazheve, listën e mesazheve

Format: JSON ose tekst
...
/info	Info për file
 ...
 Klient normal: Ka vetëm read permission ai nuk mund të modifikojë file
### 4. Prioriteti
Klientët admin kanë: përgjigje më të shpejtë si dhe qasje më të shumët se klientët në files
...
Ky projekt demonstron komunikim në rrjet me TCP menaxhim të shumë klientëve kontroll të aksesit implementim të një HTTP serveri për monitorim